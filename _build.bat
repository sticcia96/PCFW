...
IF !PROGRESS! LSS 2 ECHO MINIFY SOURCE:
IF !PROGRESS!==2 ECHO MINIFY SOURCE: IN PROGRESS
IF !PROGRESS! GEQ 3 ECHO MINIFY SOURCE: DONE
IF !PROGRESS! LSS 3 ECHO CLEAN UP:
IF !PROGRESS!==3 ECHO CLEAN UP: IN PROGRESS
IF !PROGRESS! GEQ 4 ECHO CLEAN UP: DONE
GOTO %RETURN%
